      ...
      <header className="border-b border-deep-violet/20 bg-gradient-to-r from-deep-violet/5 to-royal-blue/10 backdrop-blur-sm sticky top-0 z-50 transition-all duration-300">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          >
            ...
            <div>
              <h1 className="text-xl font-bold text-slate-dark hover:text-deep-violet transition-colors duration-300">
                EDVANCE
              </h1>
              <p className="text-xs text-deep-violet font-medium animate-pulse">PAKISTAN</p>
            </div>
          </div>
          <nav
          ...
          >
            <Link
              href="#about"
              className="text-slate-dark hover:text-deep-violet transition-all duration-300 hover:scale-105 relative group font-medium"
            >
              About
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-deep-violet transition-all duration-300 group-hover:w-full"></span>
            </Link>
            <Link
              href="#solution"
              className="text-slate-dark hover:text-deep-violet transition-all duration-300 hover:scale-105 relative group font-medium"
          ...
          <Button
            asChild
            className={`bg-deep-violet hover:bg-deep-violet/90 text-warm-ivory hover:scale-105 transition-all duration-300 hover:shadow-lg shadow-deep-violet/20 ${isVisible ? "translate-x-0 opacity-100" : "translate-x-10 opacity-0"} delay-500`}
          >
      ...
      <AnimatedSection className="py-20 px-4 relative" animation="fade-up">
        <div className="container mx-auto text-center max-w-4xl relative z-10">
          ...
          >
            <Button
              size="lg"
              className="bg-deep-violet hover:bg-deep-violet/90 text-warm-ivory hover:scale-105 hover:shadow-xl transition-all duration-300 group shadow-deep-violet/20"
              asChild
            >
              <Link href="/demo">
                See Demo
            ...
            <AnimatedSection animation="fade-right" delay={200}>
              <div className="space-y-6">
                <div className="flex items-start space-x-4 group">
                  <div className="w-8 h-8 bg-deep-violet rounded-full flex items-center justify-center flex-shrink-0 mt-1 group-hover:scale-110 group-hover:bg-deep-violet/90 transition-all duration-300 shadow-lg">
